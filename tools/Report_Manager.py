...
def app():
    ...
    if st.session_state['isGuest']:
        ...
        myDB = MyDB(st.session_state['username'], False)
        ...
        with st.form("Upload", clear_on_submit=True):
            ...
            if not not uploaded_files and submitted: # (not uploaded_files) restituisce True se la lista è vuota, quindi (not not uploaded_files) restituisce True se contiene almeno un elemento
